...
<body>
	<div id="container">
		...
		<div id="content">
			<form action="${pageContext.request.contextPath }/StuServlet?m=search" method="post">
				<table>
					<tr>
						<td>学生姓名</td>
						<td><input class="form-control" style="width:380px;" type="text" name="stuName" /></td>
					</tr>
					<tr>
                    	<td>专业名称</td>
					...
					<tr class="cols2">
						<td colspan="2"><a class="btn btn-outline-info" href="${pageContext.request.contextPath }/StuServlet?m=toAdd">添加学生</a></td>
					</tr>
