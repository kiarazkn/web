	...
	<div id="content">
		<table>
			...
			<tr class="result">
				...
				<td>
					<a href="${pageContext.request.contextPath }/SpecServlet?m=delete&specId=${spec.id}" onclick="return del_confirm();">删除</a>
				</td>
			</tr>
			</c:forEach>

			 <tr class="cols2">
                    <td colspan="2"><a href="${pageContext.request.contextPath }/specadd.jsp">添加专业</a></td>
                </tr>
			<tr class="cols2">
				<td colspan="2">
