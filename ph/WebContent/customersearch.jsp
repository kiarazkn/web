...
<div id="container">
    ...
    <div id="content">
        <form action="${pageContext.request.contextPath }/CustomerServlet?m=search" method="post">
        <!-- 通过m参数传递请求的具体操作（增删改查） -->    
            <table>
                <tr>
                    <td>客户姓名</td>
                ...
                <tr class="cols2">
                    <td colspan="2"><a href="${pageContext.request.contextPath }/customeradd.jsp">添加客户</a></td>  <!-- 实现客户信息添加功能时完善此地址 -->
                </tr>
